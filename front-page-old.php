...
<div class="main-banner">
  <div class="full-width">
    ...
    <div class="mbc"> <?php echo do_shortcode('[rev_slider alias="mobile-slider"]'); ?> </div>
  </div>
</div>
<div class="main-content container homepage-main">
  <div class="mbc">
    ...
    <div class="row">
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/makeup/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat1.jpg"></a> </div>
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/skincare/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat2.jpg"></a> </div>
    </div>
    <br>
    <div class="row">
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/hair/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat3.jpg"></a> </div>
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/body/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat4.jpg"></a> </div>
    </div>
    <br>
    <div class="row">
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/spas/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat5.jpg"></a> </div>
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/beauty-salons/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat6.jpg"></a> </div>
    </div>
    <br>
    <div class="row">
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/hair-salons/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat7.jpg"></a> </div>
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/aesthetics/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat8.jpg"></a> </div>
    </div>
    <br>
    <div class="row">
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/category/wellness/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat9-2.jpg"></a> </div>
      <div class="col-sm-6 col-xs-6"> <a href="<?php bloginfo('url'); ?>/insider-deals/"><img src="<?php bloginfo('url'); ?>/wp-content/uploads/2018/01/BS-cat10.jpg"></a> </div>
    </div>
    <div class="readmore readmore-cat" style="margin-top:10px"><a href="<?php bloginfo('url'); ?>/products/"><span>View More</span></a></div>
  </div>
  <div class="row">
    <div id="main" class="main-column col-md-9 category-columns ">
      <div class="row mbc-off2">
  ...
  <div class="row">
    <div class="col-md-12">
      <h3 class="pink-dashed"><span>Establishments</span></h3>
      <div class="featured-video-container" id="products-carousel">
  ...
  <div class="row cwidth">
  <div class="col-md-12">     
      <div class="yp-title1">Products</div><div class="clearfx"></div>
      <div class="featured-video-container" id="products-carousel">
        <?php get_template_part('section/frontpage','reviewnow'); ?>
      </div>
  </div>
  ...
  <div class="row cwidth">
      <div class="col-md-12">
      <div class="yp-title1">Establishments</div><div class="clearfx"></div>
      <div class="featured-video-container" id="products-carousel">
          <?php get_template_part('section/frontpage','reviewestablishments'); ?>
      </div>
  </div>
