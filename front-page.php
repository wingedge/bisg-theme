...
<div class="main-content container">
  <div class="row">
    <div id="main" class="main-column col-md-9 category-columns">
      ...
      <div class="row">
        <div class="col-md-4">
          <?php bi_display_brand('makeup');?>
        </div>
        <div class="col-md-4">
          <?php bi_display_brand('skincare');?>
        </div>
        <div class="col-md-4">
          <?php bi_display_brand('hair');?>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
          <?php bi_display_brand('spas');?>
        </div>
        <div class="col-md-4">
          <?php bi_display_brand('salons');?>
        </div>
        <div class="col-md-4">
          <?php bi_display_brand('wellness');?>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row" style="margin-top:15px;">
        <div class="col-md-3 col-xs-12 treatments-column">
          <a href="http://www.aestheticsandbeauty.com/treatment/anti-ageing-treatment/" target="_blank"><img class="img-responsive" src="http://beautyinsider.sg/wp-content/uploads/2014/09/anti-aging.jpg" alt="anti aging treatments" title="anti aging treatments"></a>
        ...
        <div class="col-md-3 col-xs-12 treatments-column"> <a href="http://www.aestheticsandbeauty.com/treatment_category/body/" target="_blank"><img class="img-responsive" src="http://beautyinsider.sg/wp-content/uploads/2014/09/slimming.jpg" alt="slimming treatments" title="slimming treatments"></a>
        ...
        <div class="col-md-3 col-xs-12 treatments-column"> <a href="http://www.aestheticsandbeauty.com/treatment/skin-whitening-rejuvenation/" target="_blank"><img class="img-responsive" src="http://beautyinsider.sg/wp-content/uploads/2014/09/brightening.jpg" alt="brightening treatments" title="brightening treatments"></a>
        ...
        <div class="col-md-3 col-xs-12 treatments-column"> <a href="http://www.aestheticsandbeauty.com/treatment_category/body/" target="_blank"><img class="img-responsive" src="http://beautyinsider.sg/wp-content/uploads/2014/09/enhancement.jpg" alt="enhancement treatments" title="enhancement treatments"></a>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12 treatments-column">
